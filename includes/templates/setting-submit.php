...
<p class="hoplix-submit">
	<input name="save" class="button-primary woocommerce-save-button <?php if($disabled) { echo 'disabled'; } ?>" type="submit" value="<?php esc_attr_e('Save changes', 'hoplix'); ?>" <?php if($disabled) { echo 'disabled'; } ?>/>
    ...
    <span class="loader-wrap">
        ...
        <span class="pass">
            ...
            <?php esc_html_e('Saved successfully', 'hoplix'); ?>
        </span>
        <span class="fail">
        </span>
    </span>
